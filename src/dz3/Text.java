...
public class Text {
    private String text ="   - Еh bien, mon prince. Gкnes et Lucques ne sont plus  que  des  apanages," +
            "des поместья, de la famille Buonaparte. Non, je vous prйviens, que  si  vous" +
            "ne me dites pas, que nous avons la guerre, si vous vous permettez encore  d " +
            ...
            "   - Что будет через пять лет, если это пойдет так? Voilа l'avantage  d'кtre" +
            ...
            "des 30 донесенья: покой-ер-п!. Она хорошей фамилии и богата.  Вс„,  что  мне" +
            "нужно." +
            ...
            "серебряного самовара, как будто вс„, что она ни делала, было part de plaisir" +
            ...
            "среди этих забот вс„ виден был в ней особенный страх за Пьера. Она заботливо" +
            ...
            "него, как у ребенка в игрушечной лавке, разбегались  глаза.  Он  вс„  боялся" +
            "пропустить умные разговоры, которые он может услыхать. Глядя на уверенные  и" +
            "изящные выражения лиц, собранных здесь, он  вс„  ждал  чего-нибудь  особенно" +
            ...
            "Анна Павловна одному. - Le vicomte est un parfait conteur, 47 -  проговорила" +
            ...
            "глаза в то время, как она усаживалась перед ним и освещала и его вс„ тою  же" +
            "неизменною улыбкой." +
